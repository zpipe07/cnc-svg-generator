...
func DrawSign(
	...
	case os.Getenv("FLEUR_PRODUCT_ID"):
		return drawFleur(width, height, foregroundColor, backgroundColor, lines, strokeOnly)
	...
	case os.Getenv("LAUREL_PRODUCT_ID"):
		return drawLaurel(width, height, foregroundColor, backgroundColor, lines, fontFamily, strokeOnly)
	default:
